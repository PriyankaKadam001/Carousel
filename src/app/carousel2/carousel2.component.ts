...
import {PrimeTemplate} from './carousel-template/template-type.directive';
@Component({
	selector: 'x-carousel',
	template: `
		<div [attr.id]="id" [ngClass]="{'p-carousel p-component':true, 'p-carousel-vertical': isVertical(), 'p-carousel-horizontal': !isVertical()}" [ngStyle]="style" [class]="styleClass">
			<div class="p-carousel-header" *ngIf="headerTemplate">
...
export class totalDotsCarousel2 implements AfterContentInit {
	...
	// @ContentChildren(carousel) templates: QueryList<any>;
